<?php
// 1. ALWAYS require Composer's autoloader first
require_once __DIR__ . '/vendor/autoload.php';

// 2. Start session if not already started (can come after autoloader)
if (session_status() == PHP_SESSION_NONE) {
    session_start();
}

// 3. Include your helper functions if they don't depend on the autoloader for their own definitions
//    (or if they are also autoloaded, remove this include if the template() function is also autoloaded)
include 'helpers/functions.php';

// Now the Checkout class should be found because the autoloader is active
